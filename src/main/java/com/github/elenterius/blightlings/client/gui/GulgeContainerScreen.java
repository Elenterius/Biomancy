...
public class GulgeContainerScreen extends ContainerScreen<GulgeContainer> {
	...
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(BlightlingsMod.MOD_ID, "textures/gui/gulge_inventory.png");
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int mouseX, int mouseY) {
		...
		font.func_243248_b(matrixStack, title, 10, 24 - FONT_Y_SPACING, Color.white.getRGB());
//		font.func_243248_b(matrixStack, playerInventory.getDisplayName(), posX, 51 - FONT_Y_SPACING, Color.darkGray.getRGB());
	}
