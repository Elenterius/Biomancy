package com.github.elenterius.blightlings.client.gui;

import com.github.elenterius.blightlings.BlightlingsMod;
import com.github.elenterius.blightlings.inventory.DecomposerContainer;
...
public class DecomposerContainerScreen extends ContainerScreen<DecomposerContainer> {
	...
	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation(BlightlingsMod.MOD_ID, "textures/gui/decomposer_inventory.png");
	...
	protected void renderHoveredTooltip(MatrixStack matrixStack, int mouseX, int mouseY) {
		...
		if (isInRect(guiLeft + FUEL_BAR_POS_X, guiTop + FUEL_BAR_POS_Y, FUEL_BAR_WIDTH, FUEL_BAR_HEIGHT, mouseX, mouseY)) {
			...
			hoveringText.add(BlightlingsMod.getTranslationText("tooltip", "main_fuel").appendString(": " + mainFuel + "%"));
		}
		...
		if (isInRect(guiLeft + FUEL_BAR_POS_X + FUEL_BAR_WIDTH + 4, guiTop + FUEL_BAR_POS_Y, FUEL_BAR_WIDTH, FUEL_BAR_HEIGHT, mouseX, mouseY)) {
			...
			hoveringText.add(BlightlingsMod.getTranslationText("tooltip", "speed_fuel").appendString(": " + speedFuel + "%"));
		}
