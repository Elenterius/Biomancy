...
import com.github.elenterius.blightlings.statuseffect.BlightInfectionEffect;
import com.github.elenterius.blightlings.statuseffect.FrenzyEffect;
...
public final class ModEffects {
	public static final DeferredRegister<Effect> EFFECTS = DeferredRegister.create(ForgeRegistries.POTIONS, BlightlingsMod.MOD_ID);
	...
	public static final RegistryObject<FrenzyEffect> FRENZY = EFFECTS.register("frenzy", () -> (FrenzyEffect) new FrenzyEffect(EffectType.NEUTRAL, 0xce0018)
	...
	public static final RegistryObject<BlightInfectionEffect> BLIGHT_INFECTION = EFFECTS.register("blight_infection", () -> (BlightInfectionEffect) new BlightInfectionEffect(EffectType.HARMFUL, 0xcc33cc)
