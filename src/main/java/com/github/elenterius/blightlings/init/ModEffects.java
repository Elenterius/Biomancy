...
public final class ModEffects {
	...
	public static final RegistryObject<StatusEffect> FRENZY = EFFECTS.register("frenzy", () -> (StatusEffect) new StatusEffect(EffectType.NEUTRAL, 0xce0018)
	...
	public static final RegistryObject<StatusEffect> BLIGHT_INFECTION = EFFECTS.register("blight_infection", () -> (StatusEffect) new StatusEffect(EffectType.HARMFUL, 0xcc33cc)
