...
public class DecomposingRecipeBuilder {
	...
	public void build(Consumer<IFinishedRecipe> consumerIn) {
		...
		build(consumerIn, BlightlingsMod.createRL(registryKey.getPath() + "_decomposing"));
	}
	...
	public void build(Consumer<IFinishedRecipe> consumerIn, String id, boolean suffix) {
		if (suffix) {
			...
			build(consumerIn, BlightlingsMod.createRL(registryKey.getPath() + "_" + id + "_decomposing"));
		}
		else {
			build(consumerIn, id);
		}
	...
	public void build(Consumer<IFinishedRecipe> consumerIn, String save) {
		ResourceLocation registryKey = Registry.ITEM.getKey(result);
		ResourceLocation alternative = new ResourceLocation(BlightlingsMod.MOD_ID, save + "_decomposing");
