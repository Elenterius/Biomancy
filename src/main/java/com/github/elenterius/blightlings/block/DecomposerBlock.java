...
public class DecomposerBlock extends OwnableContainerBlock {
	...
	public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		if (nbt != null) {
			...
			tooltip.add(BlightlingsMod.getTranslationText("tooltip", "main_fuel").appendString(": " + mainFuel + "%"));
			tooltip.add(BlightlingsMod.getTranslationText("tooltip", "speed_fuel").appendString(": " + speedFuel + "%"));
		}
