...
public class AttunedDamageEnchantment extends Enchantment {
	...
	public static final String NBT_KEY = "BlightlingsAttunedTarget";
...
//			name = Minecraft.getInstance().world.getPlayerByUuid(nbt.getUniqueId("playerUUID")).getDisplayName();
		...
		IFormattableTextComponent textComponent = new TranslationTextComponent("enchantment.blightlings.attuned_bane_of", name != null ? name : new StringTextComponent("null").mergeStyle(TextFormatting.OBFUSCATED, TextFormatting.RED));
