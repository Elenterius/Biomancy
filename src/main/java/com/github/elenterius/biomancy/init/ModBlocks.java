...
public final class ModBlocks {
	...
	public static final RegistryObject<RotatedPillarBlock> PRIMAL_FLESH_PILLAR = register("primal_flesh_pillar", () -> new RotatedPillarBlock(createBonyFleshProperties()));
	...
	public static final RegistryObject<MembraneBlock> PRIMAL_PERMEABLE_MEMBRANE = registerMembrane("primal_permeable_membrane", IgnoreEntityCollisionPredicate.IS_ALIVE_MOB, PrimalMembraneBlock::new);
