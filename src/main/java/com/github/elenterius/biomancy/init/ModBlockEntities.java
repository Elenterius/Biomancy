...
public final class ModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<FleshChestBlockEntity>> FLESH_CHEST = BLOCK_ENTITIES.register("flesh_chest", () -> BlockEntityType.Builder.of(FleshChestBlockEntity::new, ModBlocks.FLESH_CHEST.get()).build(noDataFixer()));
