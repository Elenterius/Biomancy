...
public final class ModItems {
	...
	public static final RegistryObject<MaykerBannerPatternItem> MASCOT_BANNER_PATTERN = registerItem("mascot_pattern", props -> new MaykerBannerPatternItem(ModBannerPatterns.MASCOT_PATTERN, props));
	public static final RegistryObject<MaykerBannerPatternItem> MASCOT_OUTLINE_BANNER_PATTERN = registerItem("mascot_outline_pattern", props -> new MaykerBannerPatternItem(ModBannerPatterns.MASCOT_OUTLINE_PATTERN, props));
	public static final RegistryObject<MaykerBannerPatternItem> MASCOT_ACCENT_BANNER_PATTERN = registerItem("mascot_accent_pattern", props -> new MaykerBannerPatternItem(ModBannerPatterns.MASCOT_ACCENT_PATTERN, props));
	...
	public static final RegistryObject<ToxicusItem> TOXICUS = registerItem("toxicus", props -> SwordSmithy.forge(ToxicusItem::new, ModTiers.LESSER_BIO_FLESH, 14, 0.7f, props.tab(null)));
	...
	private interface SwordSmithy<T extends SwordItem> {
		float PLAYER_ATTACK_DAMAGE = 1;
		float PLAYER_ATTACK_SPEED = 4;
		...
		static <T extends SwordItem> T forge(SwordSmithy<T> smithy, Tier tier, int attackDamage, float attackSpeed, Item.Properties properties) {
			int attackDamageModifier = Mth.floor(attackDamage - (PLAYER_ATTACK_DAMAGE + tier.getAttackDamageBonus()));
			float attackSpeedModifier = attackSpeed - PLAYER_ATTACK_SPEED;
