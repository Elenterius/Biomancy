...
//	public static final RegistryObject<Item> PROTEIN_BAR = ITEMS.register("protein_bar", () -> new EffectCureItem(createProperties().food(ModFoods.PROTEIN_BAR)));
	...
	public static final RegistryObject<SimpleBlockItem> FLESH_DOOR = ITEMS.register("flesh_door", () -> new SimpleBlockItem(ModBlocks.FLESH_DOOR.get(), createBaseProperties()));
	...
	public static final RegistryObject<SimpleBlockItem> FLESH_FENCE_GATE = ITEMS.register("flesh_fence_gate", () -> new SimpleBlockItem(ModBlocks.FLESH_FENCE_GATE.get(), createBaseProperties()));
