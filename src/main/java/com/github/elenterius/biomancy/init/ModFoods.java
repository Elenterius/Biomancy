...
public final class ModFoods {
	...
	public static final FoodProperties FLESH_LUMP = new FoodProperties.Builder().nutrition(2).saturationMod(0.4F).meat().build();
	public static final FoodProperties NECROTIC_FLESH_LUMP = new FoodProperties.Builder().nutrition(2).saturationMod(0.1F).meat()
