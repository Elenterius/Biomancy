...
public class KhopeshItem extends AxeItem {
	...
	public static AttributeModifier ATTACK_REACH_RIDING_MODIFIER = new AttributeModifier(UUID.fromString("e488293e-0160-4be3-b7b2-35def9b8ab7e"), "riding_attack_distance_modifier", 1f, AttributeModifier.Operation.ADDITION);
	...
	public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		...
		tooltip.add((new StringTextComponent(" ")).append(new TranslationTextComponent("attribute.modifier.plus." + ATTACK_REACH_RIDING_MODIFIER.getOperation().toValue(), ATTRIBUTE_MODIFIER_FORMAT.format(ATTACK_REACH_RIDING_MODIFIER.getAmount()), new TranslationTextComponent("attribute.generic.attack_distance"))).withStyle(TextFormatting.BLUE));
	}
