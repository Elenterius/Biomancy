...
public abstract class PlayerRendererMixin {
	...
	//TODO: this is probably also incompatible with optifine
//	@Inject(method = "getArmPose", cancellable = true, locals = LocalCapture.CAPTURE_FAILSOFT, at = @At(value = "FIELD", target = "Lnet/minecraft/client/renderer/entity/model/BipedModel$ArmPose;ITEM:Lnet/minecraft/client/renderer/entity/model/BipedModel$ArmPose;"))
