...
public final class TextStyles {
	...
	public static final Style PRIMORDIAL_RUNES_GRAY = GRAY.withFont(Fonts.CARO_INVITICA);
	public static final Style PRIMORDIAL_RUNES_LIGHT_GRAY = LIGHT_GRAY.withFont(Fonts.CARO_INVITICA);
