...
public abstract class OwnableMonsterEntity extends MonsterEntity implements IOwnableCreature {

	protected static final DataParameter<Optional<UUID>> OWNER_UNIQUE_ID = EntityDataManager.createKey(OwnableMonsterEntity.class, DataSerializers.OPTIONAL_UNIQUE_ID);

	protected OwnableMonsterEntity(EntityType<? extends MonsterEntity> type, World worldIn) {
		super(type, worldIn);
	}
