...
public final class FuelUtil {
	...
	public static final Set<Item> FUEL_ITEMS = Set.of(ModItems.NUTRIENT_PASTE.get(), ModItems.NUTRIENT_BAR.get(), ModItems.PROTEIN_BAR.get());
	...
	public static float getItemFuelValue(ItemStack stackIn) {
		...
		if (item == ModItems.NUTRIENT_PASTE.get()) return (float) DEFAULT_FUEL_VALUE * NUTRIENT_PASTE_MULTIPLIER;
		return 0;
	}
