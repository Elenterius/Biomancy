...
public class MawHopperModel extends AnimatedGeoModel<MawHopperBlockEntity> {
	...
	@Override
	public ResourceLocation getModelLocation(MawHopperBlockEntity blockEntity) {
	...
	@Override
	public ResourceLocation getTextureLocation(MawHopperBlockEntity blockEntity) {
		return TEXTURE;
	}

	@Override
	public ResourceLocation getAnimationFileLocation(MawHopperBlockEntity blockEntity) {
		return ANIMATION;
	}
