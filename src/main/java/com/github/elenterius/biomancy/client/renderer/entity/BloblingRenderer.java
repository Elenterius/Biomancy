...
import com.github.elenterius.biomancy.client.renderer.entity.model.BloblingModel;
import com.github.elenterius.biomancy.entity.BloblingEntity;
...
public class BloblingRenderer extends MobRenderer<BloblingEntity, BloblingModel<BloblingEntity>> {
	private static final ResourceLocation TEXTURE = new ResourceLocation(BiomancyMod.MOD_ID, "textures/entity/blobling.png");
	private static final ResourceLocation OVERLAY_TEXTURE = new ResourceLocation(BiomancyMod.MOD_ID, "textures/entity/blobling_overlay.png");
