...
public class AcidBlobProjectileRenderer extends GeoEntityRenderer<AcidBlobProjectile> {
	...
	@Override
	public void actuallyRender(PoseStack poseStack, AcidBlobProjectile animatable, BakedGeoModel model, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
