...
@OnlyIn(Dist.CLIENT)
public class BioInjectorScreen extends AbstractContainerScreen<BioInjectorMenu> {

	private static final ResourceLocation BACKGROUND_TEXTURE = new ResourceLocation("textures/gui/container/hopper.png");

	public BioInjectorScreen(BioInjectorMenu menu, Inventory playerInventory, Component title) {
