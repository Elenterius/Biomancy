...
import com.creativechasm.blightlings.client.renderer.entity.model.BloblingModel;
...
public class BloblingRenderer extends MobRenderer<BloblingEntity, BloblingModel<BloblingEntity>>
{
    ...
    private static final ResourceLocation EMISSION_TEXTURE = new ResourceLocation(BlightlingsMod.MOD_ID, "textures/entity/blobling_eyes.png");
