...
public class ModRecipeProvider extends RecipeProvider {
	...
	private void registerDecomposingRecipes(Consumer<FinishedRecipe> consumer) {
		...
		DecomposerRecipeBuilder.create().setIngredient(Items.TURTLE_EGG).addOutput(ModItems.BIO_MINERALS.get(), 1, 2).addOutput(ModItems.NUTRIENTS.get(), 0, 1).setCraftingTime(64).unlockedBy(Items.TURTLE_EGG).save(consumer);
		...
		DecomposerRecipeBuilder.create().setIngredient(Tags.Items.STRING).addOutput(ModItems.BIO_MINERALS.get(), -1, 1).setCraftingTime(22).unlockedBy(Tags.Items.STRING).save(consumer);
		DecomposerRecipeBuilder.create().setIngredient(Tags.Items.FEATHERS).addOutput(ModItems.TOUGH_FIBERS.get(), 1, 2).addOutput(ModItems.BIO_MINERALS.get(), 0, 1).setCraftingTime(82).unlockedBy(Tags.Items.FEATHERS).save(consumer);
		...
		DecomposerRecipeBuilder.create().setIngredient(Tags.Items.EGGS).addOutput(ModItems.BIO_MINERALS.get(), 1).addOutput(ModItems.NUTRIENTS.get(), 0, 2).setCraftingTime(62).unlockedBy(Tags.Items.EGGS).save(consumer);
		...
		DecomposerRecipeBuilder.create().setIngredient(Items.INK_SAC).addOutput(ModItems.BILE.get(), 1, 2).addOutput(ModItems.ELASTIC_FIBERS.get(), 1, 2).setCraftingTime(52).unlockedBy(Items.INK_SAC).save(consumer);
		DecomposerRecipeBuilder.create().setIngredient(Items.GLOW_INK_SAC).addOutput(ModItems.BIO_LUMENS.get(), 3, 5).addOutput(ModItems.ELASTIC_FIBERS.get(), 1, 2).setCraftingTime(130).unlockedBy(Items.GLOW_INK_SAC).save(consumer);
		...
		DecomposerRecipeBuilder.create().setIngredient(Items.CARROT).addOutput(ModItems.ORGANIC_MATTER.get(), 1, 2).setCraftingTime(40).unlockedBy(Items.CARROT).save(consumer);
		DecomposerRecipeBuilder.create().setIngredient(Items.POTATO).addOutput(ModItems.ORGANIC_MATTER.get(), 1, 2).setCraftingTime(40).unlockedBy(Items.POTATO).save(consumer);
		...
		DecomposerRecipeBuilder.create().setIngredient(Items.PHANTOM_MEMBRANE).addOutput(ModItems.TOUGH_FIBERS.get(), 4, 7).addOutput(ModItems.BIO_MINERALS.get(), 1, 2).addOutput(ModItems.EXOTIC_DUST.get(), 1, 3).setCraftingTime(404).unlockedBy(Items.PHANTOM_MEMBRANE).save(consumer);
		...
		DecomposerRecipeBuilder.create().setIngredient(Items.GLOW_BERRIES).addOutput(ModItems.BIO_LUMENS.get(), 0, 1).addOutput(ModItems.ORGANIC_MATTER.get(), -1, 1).setCraftingTime(42).unlockedBy(Items.GLOW_BERRIES).save(consumer);
		DecomposerRecipeBuilder.create().setIngredient(Items.SHROOMLIGHT).addOutput(ModItems.BIO_LUMENS.get(), 5, 9).addOutput(ModItems.ORGANIC_MATTER.get(), 2, 3).setCraftingTime(258).unlockedBy(Items.SHROOMLIGHT).save(consumer);
